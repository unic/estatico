...
gulp.task('build', function(cb) {
	...
	runSequence('clean', ['js:lodash', 'js:templates', 'media:iconfont', 'media:dataurls', 'media:pngsprite'], 'js:modernizr', ['html', 'css', 'js:lint', 'js:default', 'media:copy'], function(err) {
		if (err) {
			helpers.errors(err);
		}
