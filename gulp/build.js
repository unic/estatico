...
gulp.task('build', function (cb) {
	...
	runSequence('clean', ['js:lodash', 'media:iconfont', 'media:pngsprite'], 'js:modernizr', ['html', 'css:default', 'css:styleguide', 'js:hint', 'js:head', 'js:main', 'media:copy'], function (err) {
		if (err) {
