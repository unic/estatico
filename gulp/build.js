...
gulp.task('build', function(cb) {
	...
	runSequence('clean', ['css:colors', 'js:lodash', 'js:templates', 'media:iconfont', 'media:dataurls', 'media:pngsprite'], 'js:modernizr', ['html', 'css:default', 'js:lint', 'js:default', 'media:copy'], 'qunit:test', function(err) {
		if (err) {
			helpers.errors(err);
		}
